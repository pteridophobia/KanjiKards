...
def hiragana_to_romanji(hira):
    ...
    for h in str1:
        ...
        i+=1
    return romanji
#This will be the head of out list of KanjiKards
head = KanjiKard()
head.kanji = '頭'
head.english = 'head'
head.grade_level = 2
...
list_file = open("kanji_list.txt", "w")
...
for h in tokens:
    if len(h) == 1:
        ...
        list_file.write("\n")
        kanji_list.append(single)
        i += 1
        if single in grade1:
            grade_level = 1
        elif single in grade2:
            grade_level = 2
        elif single in grade3:
            grade_level = 3
        elif single in grade4:
            grade_level = 4
        elif single in grade5:
            grade_level = 5
        elif single in grade6:
            grade_level = 6
        elif single in secondary:
            grade_level = 9
        print(grade_level)
